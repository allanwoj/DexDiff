...
public enum InstructionCodec {
    FORMAT_00X() {
        @Override public DecodedInstruction decode(long opcodeUnit,
                CodeInput in) throws EOFException {
        	ArrayList<Byte> l = new ArrayList<Byte>();
            l.add((byte)byte0(opcodeUnit));
            l.add((byte)byte1(opcodeUnit));
            return new DecodedInstruction(
                    this, (int)opcodeUnit, 0, null,
                    0, 0L, l);
        }
    ...
    FORMAT_10T() {
        @Override public DecodedInstruction decode(long opcodeUnit,
            ...
            return new DecodedInstruction(
                    this, opcode, 0, null,
                    baseAddress + target, 0L, l);
        }

        @Override public void encode(DecodedInstruction insn, CodeOutput out) {
            int relativeTarget;
			try {
				relativeTarget = insn.getTargetByte(out.cursor());
    ...
    FORMAT_20T() {
        @Override public DecodedInstruction decode(long opcodeUnit,
            ...
            return new DecodedInstruction(
                    ...
                    baseAddress, literal, l);
        }

        @Override public void encode(DecodedInstruction insn, CodeOutput out) {
            short relativeTarget;
			try {
				relativeTarget = insn.getTargetUnit(out.cursor());
    ...
    FORMAT_20BC() {
        @Override public DecodedInstruction decode(long opcodeUnit,
            ...
            return new DecodedInstruction(
            		...
            		this, opcode, 0, IndexType.VARIES,
                    0, literal, l);
        }
    ...
    FORMAT_22CS() {
        @Override public DecodedInstruction decode(long opcodeUnit,
            ...
            l.addAll(in.read());
            return new DecodedInstruction(
                    this, opcode, 0, IndexType.FIELD_OFFSET,
                    0, 0L, l);
        }
        ...
        @Override public DecodedInstruction decode(long opcodeUnit,
            ...
            switch (opcode) {
                ...
                case Opcodes.SPARSE_SWITCH: {
                    ...
                    in.setBaseAddress(0, baseAddress);
                	break;
                }
            }
    ...
    FORMAT_40SC() {
        @Override public DecodedInstruction decode(long opcodeUnit,
            ...
            l.addAll(in.read());
            return new DecodedInstruction(
                    this, (int)opcodeUnit, 0, IndexType.VARIES,
                    0, 0, l);
        }
    ...
    FORMAT_41C() {
        @Override public DecodedInstruction decode(long opcodeUnit,
            ...
            //int index = in.readInt();
            //int a = in.read();
            IndexType indexType = OpcodeInfo.getIndexType((int)opcodeUnit);
            ArrayList<Byte> l = new ArrayList<Byte>();
            l.add((byte)byte0(opcodeUnit));
            l.add((byte)byte1(opcodeUnit));
            l.addAll(in.readInt());
            l.addAll(in.read());
            return new DecodedInstruction(
                    this, (int)opcodeUnit, 0, indexType,
                    0, 0L, l);
        }
    ...
    FORMAT_PACKED_SWITCH_PAYLOAD() {
        @Override public DecodedInstruction decode(long opcodeUnit,
            ...
            return new DecodedInstruction(
                    this, (int)opcodeUnit, 0, null, 0, 0, l);
        }
    ...
    FORMAT_SPARSE_SWITCH_PAYLOAD() {
        @Override public DecodedInstruction decode(long opcodeUnit,
            ...
            l.add((byte)byte1(opcodeUnit));
            l.addAll(in.read());
            int size = (((l.get(3)) << 8) & 0x0000ff00) | (l.get(2) & 0x000000ff);
    ...
    FORMAT_FILL_ARRAY_DATA_PAYLOAD() {
        @Override public DecodedInstruction decode(long opcodeUnit,
            ...
            l.addAll(in.read());
            l.addAll(in.readInt());
            int elementWidth = (((l.get(3)) << 8) & 0x0000ff00) | (l.get(2) & 0x000000ff);
            //int size = ((l.get(7)) << 24)  | ((l.get(6)) << 16)  | ((l.get(5)) << 8) | l.get(4);
            int size = (((l.get(7)) << 24) & 0xff000000)  | (((l.get(6)) << 16) & 0x00ff0000)  | (((l.get(5)) << 8) & 0x0000ff00) | (l.get(4) & 0x000000ff);
            ...
            throw new EOFException("bogus element_width: "
                    + Hex.u2(elementWidth));
        }
     ...
     */
    public abstract DecodedInstruction decode(long opcodeUnit, CodeInput in)
        throws EOFException;
    ...
    private static DecodedInstruction decodeRegisterList(
            InstructionCodec format, long opcodeUnit, CodeInput in)
            throws EOFException {
        int opcode = byte0(opcodeUnit);
    ...
    private static int byte0(long value) {
        return (int)(value & 0xff);
    }

    private static int byte1(long value) {
